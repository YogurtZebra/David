...
lib.ssMetadata = [
		{name:"David_atlas_", frames: [[0,0,1458,1128],[1460,0,414,492],[1460,1000,95,94],[1460,494,251,251],[1460,747,251,251]]}
];
...
(lib.CachedBmp_5 = function() {
	this.initialize(ss["David_atlas_"]);
	this.gotoAndStop(0);
...
(lib.David_HTML5Canvas = function(mode,startPosition,loop) {
	...
	this.instance_4.setTransform(-28.45,-17.45,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(138));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(291.6,222.6,409,324);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/David_atlas_.png", id:"David_atlas_"}
	],
	preloads: []
};
